    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {messages.map((m) => (
            <div key={m.id} className="bg-card rounded-xl p-5 shadow-card border border-border/50">
              ...
              <p className="text-sm text-foreground mt-3 bg-muted rounded-lg p-3">{m.message}</p>
            </div>
          ))}
        </div>
      )}
